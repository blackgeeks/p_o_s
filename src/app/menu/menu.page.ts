...
export class MenuPage implements OnInit {
    ...
    constructor(private storage: Storage, public popoverController: PopoverController, public modalCtrl: ModalController) {
    ...
    async openMenuPopover(ev: Event, item: any) {
